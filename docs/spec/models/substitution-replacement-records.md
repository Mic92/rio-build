...
`docs/spec/models/substitution-replacement-invariant-map.md` @ `690a921be`
...
| 9 | `setup_with_mock_store_materialization_enabled` alias fold-in (~30 call sites onto `setup_with_mock_store`) | CLOSED (2026-06-02, this commit): alias folded `17cfa8624` — 35 call sites onto `setup_with_mock_store`, alias deleted, test count unchanged |
